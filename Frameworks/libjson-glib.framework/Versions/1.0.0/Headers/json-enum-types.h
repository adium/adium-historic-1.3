...
/* enumerations from "/Sources/adium-1.3/Utilities/dep-build-scripts/source/json-glib-0.7.6/json-glib/json-parser.h" */
GType json_parser_error_get_type (void) G_GNUC_CONST;
#define JSON_TYPE_PARSER_ERROR (json_parser_error_get_type())

/* enumerations from "/Sources/adium-1.3/Utilities/dep-build-scripts/source/json-glib-0.7.6/json-glib/json-types.h" */
